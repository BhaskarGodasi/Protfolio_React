...
const HeaderSocials = () => {
    return (
        <div className='home__socials'>
            <a href='https://github.com/BhaskarGodasi' className='home__social-link' target='_blank' rel='noreferrer'>
                <FaGithub />
            </a>
            ...
            <a href='https://www.linkedin.com/in/bhaskar-godasi/' className='home__social-link' target='_blank' rel='noreferrer'>
                <FaLinkedinIn />
            </a>
